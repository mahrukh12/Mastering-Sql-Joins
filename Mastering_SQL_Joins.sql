...
-- Solution to 2.2
SELECT e.hire_date, e.first_name, e.last_name, e.emp_no, d.dept_no
FROM employees e
...
SELECT e.emp_no, e.first_name, e.last_name, e.hire_date, dm.dept_no, dm.from_date
FROM employees e
LEFT JOIN dept_manager dm
ON e.emp_no = dm.emp_no
